...
import strategies.comparators.GreenEnergyChoiceSort;
...
public final class GreenEnergyChoiceStrategy implements EnergyChoiceStrategy {
    ...
    public List<Producer> getEnergyProducers() {
        ...
        Comparator<Producer> sortMethod = new GreenEnergyChoiceSort();
        // sorts database of producers using green strategy
